...
################################################################################
# Build Script for M365 Installer Intune Package
...
# Configuration
PACKAGE_NAME="M365Installer"
VERSION="1.0.0"
IDENTIFIER="com.sbsfederal.m365installer"
INSTALL_LOCATION="/tmp/m365installer"
...
echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}Microsoft 365 Installer - Package Builder${NC}"
echo -e "${BLUE}=========================================${NC}"
...
if [ -f "../scripts/m365-installer.sh" ]; then
    cp ../scripts/m365-installer.sh build/payload/
    echo "  ✓ Copied m365-installer.sh"
else
    echo -e "${RED}Error: m365-installer.sh not found in ../scripts/ directory${NC}"
    exit 1
fi
...
chmod +x build/payload/m365-installer.sh
...
<installer-gui-script minSpecVersion="1">
    <title>Microsoft 365 Installer</title>
